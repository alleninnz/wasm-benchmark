...
/// Optimized version that caches squared values while preserving exact computation order
...
mod tests {
    ...
    fn test_mandelbrot_known_points() {
        ...
        assert!(
            iterations_outside < 10,
            "Point (2,2) should diverge quickly, got {} iterations",
            iterations_outside
        );
        ...
        assert!(
            iterations_boundary > 100,
            "Point (-0.75, 0) should have high iteration count"
        );
    }
