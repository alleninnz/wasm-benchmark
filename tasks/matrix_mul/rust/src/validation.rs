...
mod tests {
    ...
    fn test_valid_parameters() {
        ...
        assert!(
            ...
            "Valid small parameters should pass"
        );
        ...
        assert!(
            validate_parameters(&params),
            "Valid medium parameters should pass"
        );
        ...
        assert!(
            validate_parameters(&params),
            "Valid large parameters should pass"
        );
    }
    ...
    fn test_invalid_dimensions() {
        ...
        assert!(
            !validate_parameters(&params),
            "Zero dimension should be invalid"
        );
        ...
        assert!(
            !validate_parameters(&params),
            "Too large dimension should be invalid"
        );
        ...
        assert!(
            !validate_parameters(&params),
            "Overflow-causing dimension should be invalid"
        );
    }
    ...
    fn test_memory_limits() {
        ...
        assert!(
            validate_parameters(&params),
            "2000x2000 should be within limits"
        );
        ...
        assert!(
            !validate_parameters(&params),
            "3000x3000 should exceed memory limits"
        );
    }
    ...
    fn test_edge_case_dimensions() {
        ...
        assert!(
            validate_parameters(&params),
            "Exactly at max dimension should be valid"
        );
    }
}
