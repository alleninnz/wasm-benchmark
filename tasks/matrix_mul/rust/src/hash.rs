...
mod tests {
    ...
    fn test_round_f32_to_precision() {
        ...
        assert_eq!(round_f32_to_precision(1.23456789, 4), 12346); // Rounds up
        assert_eq!(round_f32_to_precision(1.23454321, 4), 12345); // Rounds down
    ...
    fn test_fnv1a_hash_matrix_different() {
        ...
        assert_ne!(hash1, hash2, "Different matrices should produce different hashes");
    }
    ...
    fn test_fnv1a_hash_empty_matrix() {
        ...
        assert_eq!(hash, FNV_OFFSET_BASIS, "Empty matrix should hash to offset basis");
    }
    ...
    fn test_fnv1a_hash_precision_rounding() {
        ...
        if rounded1 == rounded2 {
            ...
            let hash1 = fnv1a_hash_matrix(&matrix1);
            let hash2 = fnv1a_hash_matrix(&matrix2);
            assert_eq!(hash1, hash2, "Values that round to same precision should hash equally");
        }
        ...
        assert_ne!(hash3, hash4, "Clearly different values should hash differently");
    }
    ...
    fn test_hash_order_sensitivity() {
        ...
        assert_ne!(hash1, hash2, "Different element orders should produce different hashes");
    }
}