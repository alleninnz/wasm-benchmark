...
`make run quick` 是 WebAssembly Benchmark 项目中用于快速开发测试的关键命令，提供 5-10秒的快速反馈，相比完整测试套件的 30+分钟大幅提升开发效率。本文档详细分析其完整的执行链路、涉及文件、核心方法和架构设计。
...
| `make run quick` | 5-10秒                     | 微型规模 | 开发验证、CI 冒烟测试  |
